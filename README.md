...
**Файл виконання:**  
[`task_01_tree_copy_sort.py`](./task_01_tree_copy_sort.py)

**Додатково було створено генератор файлів.каталогів різного рівня вкладеності.**
[`task_01_test_data_generator.py`](./task_01_test_data_generator.py)
...
**Файл виконання:**  
[`task_02_koch_snowflake.py`](./task_02_koch_snowflake.py)